KManager.action :bootstrap do
  action do
    application_name = :transcript_whisperer
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'A concise command line tool that generates transcriptions from video, audio, or YouTube inputs utilising OpenAI Whisper to produce professionaly edited transcripts.',
        ...
        application_lib_namespace:  'TranscriptWhisperer',
        namespaces:                 ['TranscriptWhisperer'],
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 'As a youtube content creator, I want to process video, audio, youtube or youtube transcript into grammatically clean transcript, so that I can use it for lower thirds and youtube descriptions',
        copyright_date:             '2022',
...
KManager.opts.app_name                    = 'transcript_whisperer'
